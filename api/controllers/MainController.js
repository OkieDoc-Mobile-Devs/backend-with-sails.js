...
let users = [
  { id: 1, name: "John Doe", age: 33 }, //0
  { id: 2, name: "Mary Jane Watson", age: 35 }, //1
  { id: 3, name: "Betty Crocker", age: 60 }, //2
];
...
module.exports = {
  ...
  getUserById: function (req, res) {
    ...
    if (!foundUser) {
      res
        .status(404)
        .status(404)
        .send("Error!! User not found ${req.params.id} is not found");
    }
    res.json(foundUser);
  },
  ...
  updateUser: function (req, res) {
    ...
    res
      .status(200)
      .send(`User with id ${req.params.id} has been updated successfully!`);
